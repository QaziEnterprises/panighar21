...
export default function CategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
              ...
              <Card key={i} className="group overflow-hidden hover:shadow-xl transition-all duration-300 border-border hover:border-primary/30">
                <CardContent className="p-0">
                  ...
                  <div className="p-5 space-y-3">
                    ...
                    <a href={`https://wa.me/923007811479?text=${encodeURIComponent(`Hi PaniGhar, I want to inquire about ${p.name} (${p.price}).`)}`} target="_blank" rel="noopener noreferrer">
      ...
      <a
        href={`https://wa.me/923007811479?text=${encodeURIComponent("Assalam o Alaikum! I'm interested in PaniGhar water solutions. Can you please share more details?")}`}
        target="_blank"
